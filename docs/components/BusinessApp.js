...
export default class BusinessApp extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        const mdText = require('text!../mdFile/business.md');
        return (<div className="umpui-component">
            <h3 className="umpui-layer umpui-title">Business组件</h3>
            {this.generateWidget()}

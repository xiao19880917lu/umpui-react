                    ...
                    $.each(this.state.item.config, function (dex, item) {
                        ...
                        switch (item.type) {
                            case 'select':
                                ...
                                liList.push(<li key={'modal' + dex}>
                                    <label>{item.label}</label>
                                    <Selected ref={item.name}{...selectedProps} btnStyle="primary" multiple={false}/></li>);
                                break;
                            case 'input':
                                liList.push(<li key={'modal' + dex}><label>{item.label}</label>
                            ...
                            case 'datetime':
                                liList.push(<li key={'modal' + dex}><label>{item.label}</label>
                                    <DateTimeField ref={item.name} name={item.name} standalone/>
                                </li>);
                                break;
                            default:
                                break;

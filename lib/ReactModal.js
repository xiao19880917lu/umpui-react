...
export default class ReactModal extends React.Component {
    ...
    handleClick(actionType) {
        ...
        if (actionType === 'confirm') {
            ...
            if (this.props.data) {
                params = $.extend({}, this.props.data, ckObj ? ckObj : this.params, true);
            }
            this.props.handleModalClick && this.props.handleModalClick(this.props.item, ckObj ? ckObj : params);
        ...
        return (
            <div id="modal" style={style}>
                ...
                <div ref="reactModal" className="my-prompt" draggable='true'
                    ...
                    <div data-name="cancel" className="title" onClick={this.handleClick.bind(this, 'cancel')}></div>
                    {this.generateModal()}

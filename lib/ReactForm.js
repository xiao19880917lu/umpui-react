...
export default class ReactForm extends React.Component {
    ...
    render() {
        let strHeader = <span>{this.props.config && this.props.config.title ? this.props.config.title : ''}
        {this.props.config && this.props.config.removeIcon ? <i onClick={this.handleRemove.bind(this)}

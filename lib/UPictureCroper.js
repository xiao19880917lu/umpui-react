/**
 * @file UPictureCroper.js
 * @auth huzaibin<huzaibin@baidu.com>
 */
    ...
    render() {
        return (
            <div className='pictureModal'>
                <img className='originalPic' src={this.state.imgBase64 == null
                    ? this.props.imgSrc : this.state.imgBase64} alt='请点击编辑图片'
                    onClick={this.handleOpen.bind(this)} />
                <Modal className='pictureEdit' title='编辑图片'
                    visible={this.state.visible} onOk={this.handleCropper.bind(this, this.props.handleCropperUpload)}
                    onCancel={this.handleClose.bind(this)} width='70%' >
                    <Upload name='file' showUploadList={false} onChange={this.onChange.bind(this)} >
                        <Button type="button">
                            <Icon type="upload">点击上传</Icon>
                        </Button>
                    </Upload>
                    <div className='pictureCrop' style={{width: '100%', height: '250', padding: '5'}}>
                        <div className="box" style={{width: '160', height: '100%',
                            float: 'left', margin: '5', paddingTop: '30'}}>
                            <div style={{fontSize: '16', textAlign: 'center'}}>图片预览</div>
                            <div className="img-preview" style={{width: '160', height: '160',
                                overflow: 'hidden', border: '1px solid silver'}}/>
                        </div>
                        <div className='pictureContainer' style={{height: '100%',

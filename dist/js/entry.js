...
/******/ 	__webpack_require__.p = "./resources/dcim/dist/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Breadcrumbs = __webpack_require__(157);
	var TreeView = __webpack_require__(135);;
	var Animate = __webpack_require__(153);
	...
	var Base = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            { className: "wrapper" },
	            _react2.default.createElement(TreeView, { data: treeViewData }),
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "breadcrumbs-home", key: "0" },
	                    _react2.default.createElement("span", { className: "breadcrumbs-idcon mif-home mif-lg" }),
	                    _react2.default.createElement(Breadcrumbs, { routes: this.props.routes, params: this.props.params, setDocumentTitle: true })
	                ),
	...
	var Section = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            { style: { 'zIndex': '111', 'backgroundColor': 'red' } },
	            "huzaibin"
	        );
	    }
	});

	var Section1 = _react2.default.createClass({
	    displayName: "Section1",

	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            { style: { 'zIndex': '111', 'backgroundColor': 'green' } },
	            "huzaibin"
	        );
	    }
	});

	var historyConfig = (0, _reactRouter.useRouterHistory)(_history.createHashHistory)({
	    basename: '/'
	});
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: "/", component: Base, name: "DCIM" },
	        _react2.default.createElement(_reactRouter.IndexRoute, { component: Section, name: "IndexRoute" }),
	        "   //这是需要自定义的组件",
	        _react2.default.createElement(_reactRouter.Route, { path: "/baidu/:id", component: Section1, name: "Biadu", staticName: "true" }),
	        _react2.default.createElement(_reactRouter.Route, { path: "/sss", component: Section1, name: "SSS", staticName: "true" })
	    ),
	    _react2.default.createElement(_reactRouter.Route, { name: "404: No Match for route", path: "*", component: NoMatch })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibUseBasename = __webpack_require__(98);
	    ...
	    render: function render() {
	        ...
	        if (data) {
	            ...
	            data.forEach(function (node, i) {
	                node.pHref = '/';
	                children.push(_react2.default.createElement(TreeNode, { node: node, key: i,
	                    level: 1,
	                    visible: true,
	                    options: _this.props }));
	            });
	        ...
	        return _react2.default.createElement(
	            'div',
	            { id: 'treeview', className: 'treeview animated fade in' },
	            _react2.default.createElement(
	                'ul',
	    ...
	    render: function render() {
	        ...
	        if (node.nodes) {
	            if (!this.state.expanded) {
	                expandCollapseIcon = _react2.default.createElement('i', { className: options.expandIcon,
	                    onClick: this.toggleExpanded.bind(this, node.nodeId) });
	            } else {
	                expandCollapseIcon = _react2.default.createElement('i', { className: options.collapseIcon,
	                    onClick: this.toggleExpanded.bind(this, node.nodeId) });
	            }
	        } else {
	            expandCollapseIcon = _react2.default.createElement('i', { className: options.emptyIcon });
	        }

	        var nodeIcon = _react2.default.createElement(
	            'span',
	            { className: 'icon' },
	            _react2.default.createElement('i', { className: node.icon || options.nodeIcon })
	        );
	        ...
	        if (options.enableLinks) {
	            ...
	            nodeText = _react2.default.createElement(
	                _reactRouter.Link,
	                { to: toLink, title: node.text, style: style },
	                node.text
	            );
	        } else {
	            nodeText = _react2.default.createElement(
	        ...
	        if (node.nodes) {
	            ...
	            node.nodes.forEach(function (n, i) {
	                ...
	                children.push(_react2.default.createElement(TreeNode, { key: i, node: n,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload = __webpack_require__(83);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _useBeforeUnload2 = __webpack_require__(83);
	...
	var _enableBeforeUnload2 = __webpack_require__(140);

	var _enableBeforeUnload3 = _interopRequireDefault(_enableBeforeUnload2);

	exports.enableBeforeUnload = _enableBeforeUnload3['default'];

	var _enableQueries2 = __webpack_require__(141);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _interopRequireDefault(e) {
	  ...
	  function e(e, t) {
	    ...
	    _react = __webpack_require__(4),
	    _react2 = _interopRequireDefault(_react),
	    _reactRouter = __webpack_require__(55),
	    _exenv = __webpack_require__(158),
	    _exenv2 = _interopRequireDefault(_exenv),
	    Breadcrumbs = function (e) {
	  function t() {
	    _classCallCheck(this, t);var e = _possibleConstructorReturn(this, Object.getPrototypeOf(t).call(this));return e.displayName = "Breadcrumbs", e;
	  }return _inherits(t, e), _createClass(t, [{ key: "_getDisplayName", value: function value(e) {
	      var t = null;return t = e.indexRoute ? e.indexRoute.displayName || null : e.displayName || null, !t && e.name && (t = e.name), !t && this.props.displayMissing && (t = this.props.displayMissingText), t;
	    } }, { key: "_resolveRouteName", value: function value(e) {
	      var t = this._getDisplayName(e);return !t && e.breadcrumbName && (t = e.breadcrumbName), !t && e.name && (t = e.name), t;
	    } }, { key: "_processRoute", value: function value(e, t, r, a, s) {
	      var p = this;if (!e.path && this.props.hideNoPath) return null;var n = "",
	          o = "",
	          i = "",
	          u = this._resolveRouteName(e);if (u && "excludes" in this.props && this.props.excludes.some(function (e) {
	        return e === u;
	      })) return null;var l = a;l && (l = !!e.childRoutes, l = t !== r + 1), n = t !== r + 1 ? this.props.separator : "", l || (n = ""), e.hasOwnProperty("breadcrumblink") && (l = e.breadcrumblink), this.props.params && (o = Object.keys(this.props.params).map(function (e) {
	        return i = e, p.props.params[e];
	      }));var c = e.path.split("/")[e.path.split("/").length - 1],
	          f = void 0;if (e.path.split("/").map(function (t) {
	        if (":" == t.substring(0, 1) && p.props.params) {
	          f = Object.keys(p.props.params).map(function (e) {
	            return p.props.params[e];
	          });var r = e.path.split("/").map(function (e) {
	            return ":" == e.substring(0, 1) ? f.shift() : e;
	          });e.path = r.reduce(function (e, t) {
	            return e + "/" + t;
	          }), e.staticName || ":" != c.substring(0, 1) || (u = r.reduce(function (e, t) {
	            return t;
	          })), "function" == typeof e.prettifyParam && (u = e.prettifyParam(u));
	        }
	      }), u) {
	        this.props.prettify && (u = u.replace(/-/g, " "), u = u.replace(/\w\S*/g, function (e) {
	          return e.charAt(0).toUpperCase() + e.substr(1).toLowerCase();
	        }));var h = this.props.itemClass;if (l) var m = s ? _react2["default"].createElement(_reactRouter.Link, { to: e.path, params: e.params }, u) : u;else m = u, h += " " + this.props.activeItemClass;return s ? _react2["default"].createElement(this.props.itemElement, { className: h, key: 100 * Math.random() }, m, n) : m;
	      }return null;
	    } }, { key: "_buildRoutes", value: function value(e, t) {
	      var r = this,
	          a = [],
	          s = e[1] && e[1].hasOwnProperty("path"),
	          p = "/",
	          n = [];return e.forEach(function (e, t) {
	        var a = JSON.parse(JSON.stringify(e));"function" == typeof e.prettifyParam && (a.prettifyParam = e.prettifyParam), "props" in a && "path" in a.props && (a.path = a.props.path, a.children = a.props.children, a.name = a.props.name, a.prettifyParam = a.props.prettifyParam), a.path && ("/" === a.path.charAt(0) ? p = a.path : ("/" !== p.charAt(p.length - 1) && (p += "/"), p += a.path)), t > 0 && a.path && "/" !== a.path.charAt(0) && (a.path = p);var s = r._resolveRouteName(a);"excludes" in r.props && r.props.excludes.some(function (e) {
	          return e === s;
	        }) || n.push(a);
	      }), e = n, e.map(function (n, o) {
	        if (!n) return null;"props" in n && "path" in n.props && (n.path = n.props.path, n.children = n.props.children, n.name = n.props.name), n.path && ("/" === n.path.charAt(0) ? p = n.path : ("/" !== p.charAt(p.length - 1) && (p += "/"), p += n.path)), o > 0 && n.path && "/" !== n.path.charAt(0) && (n.path = p);var i = r._processRoute(n, e.length, a.length, s, t);i && a.push(i);
	      }), _exenv2["default"].canUseDOM && window && window.document && "setDocumentTitle" in this.props && this.props.setDocumentTitle && (window.document.title = a[a.length - 1].props.children[0]), t ? _react2["default"].createElement(this.props.wrapperElement, { className: this.props.customClass || this.props.wrapperClass }, a) : a;
	    } }, { key: "render", value: function value() {
	      var e = arguments.length <= 0 || void 0 === arguments[0] ? !0 : arguments[0];return this._buildRoutes(this.props.routes, e);
	    } }]), t;
	}(_react2["default"].Component);Breadcrumbs.propTypes = { separator: _react2["default"].PropTypes.oneOfType([_react2["default"].PropTypes.element, _react2["default"].PropTypes.string]), displayMissing: _react2["default"].PropTypes.bool, prettify: _react2["default"].PropTypes.bool, displayMissingText: _react2["default"].PropTypes.string, displayName: _react2["default"].PropTypes.string, breadcrumbName: _react2["default"].PropTypes.string, wrapperElement: _react2["default"].PropTypes.string, wrapperClass: _react2["default"].PropTypes.string, itemElement: _react2["default"].PropTypes.string, itemClass: _react2["default"].PropTypes.string, customClass: _react2["default"].PropTypes.string, activeItemClass: _react2["default"].PropTypes.string, excludes: _react2["default"].PropTypes.arrayOf(_react2["default"].PropTypes.string), hideNoPath: _react2["default"].PropTypes.bool, routes: _react2["default"].PropTypes.arrayOf(_react2["default"].PropTypes.object).isRequired, setDocumentTitle: _react2["default"].PropTypes.bool }, Breadcrumbs.defaultProps = { separator: " > ", displayMissing: !0, displayMissingText: "Missing name prop from Route", wrapperElement: "div", wrapperClass: "breadcrumbs", itemElement: "span", itemClass: "", activeItemClass: "", customClass: "breadcrumbs", excludes: [""], prettify: !1, hideNoPath: !0, setDocumentTitle: !1 }, Breadcrumbs.contextTypes = { routes: _react2["default"].PropTypes.array, params: _react2["default"].PropTypes.array }, module.exports = Breadcrumbs;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _historyLibCreateBrowserHistory = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapObject = __webpack_require__(251);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./treeview.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/sass-loader/index.js!./treeview.scss");
